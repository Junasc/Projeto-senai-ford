...
## 🎯 Objetivo
Desafio do modulo final do curso, utilizando javascript, html, css, bootstrap, rxjs e angular.


## ✒️ Justificativa

Testar minhas habilidades aprendidas durante o curso de formação front-end do senai cimatec.
